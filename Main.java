...
//Дано вещественное число x. Вычислить x - x^3/3!+x^5/5!...x^13/13!
public class Main {
...
class lab2{
    //Около стены наклонно стоит палка длиной 4,5 м. Нижний конец находится на расстоянии 3 м от стены. Он начинает
...
class lab3{
    ...
    public static void main(String[] args) {
        //В области N районов. Известны количество жителей (в тыс. чел.) и площадь (в км2) каждого района.
